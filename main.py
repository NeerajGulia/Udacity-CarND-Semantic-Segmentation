...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    output_layer4 = tf.layers.conv2d_transpose(skip_connection_layer4, num_classes, 4,2, padding='SAME', kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3))
    ...
    output_layer3 = tf.layers.conv2d_transpose(skip_connection_layer3, num_classes, 16,8, padding='SAME', kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3))
